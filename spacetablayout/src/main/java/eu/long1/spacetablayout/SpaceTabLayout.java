...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_live_tv_black_24dp);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_fingerprint_black_24dp);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_five);
